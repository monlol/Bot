...
async def dzai(ctx):
    ...
    embed1.add_field(name="!mute @user <thời gian> [lý do]", value="Mute", inline=False)
    ...
    embed1.add_field(name="!solo @user <số_lượng> <nội dung> [emoji]", value="Đấu spam", inline=False)
    ...
    embed2.add_field(name="!allow_badword <từ>", value="Cho phép từ chửi bậy", inline=False)
    embed2.add_field(name="!allow_bad_member @user", value="Cho phép thành viên được chửi bậy", inline=False)
    embed2.add_field(name="!remove_allow_badword <từ>", value="Xóa từ khỏi whitelist chửi bậy", inline=False)
    embed2.add_field(name="!remove_allow_bad_member @user", value="Xóa member khỏi whitelist chửi bậy", inline=False)
